      ...
      <main className="bg-warm-50 min-h-screen">
        ...
        <section className="py-12">
          <div className="container-main">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4 border-l-4 border-forest-700 pl-4">
              <h2 className="text-2xl font-bold text-gray-900">ทรัพย์แนะนำ</h2>
              <Link href="/properties" className="text-forest-700 font-semibold flex items-center gap-1 hover:gap-2 transition-all text-sm">
