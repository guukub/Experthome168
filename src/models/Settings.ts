...
const SettingsSchema = new mongoose.Schema({
  ...
  livingInsiderLogoUrl: { type: String, default: '' },
  ddpropertyLogoUrl: { type: String, default: '' },
  propertyhubLogoUrl: { type: String, default: '' },
  ...
  propertyTypes: { type: [String], default: ['บ้านเดี่ยว', 'ทาวน์เฮ้าส์', 'คอนโด', 'ที่ดิน', 'อาคารพาณิชย์'] },
}, { timestamps: true })
